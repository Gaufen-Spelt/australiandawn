...
window.drawFactionChart = function() {
    var factions = [
        { name: 'Left FI',      strength: dendryUI.dendryEngine.state.qualities.left_fi_strength,      dissent: dendryUI.dendryEngine.state.qualities.left_fi_dissent,      color: '#8B0000' },
        { name: 'Left IN',      strength: dendryUI.dendryEngine.state.qualities.left_in_strength,      dissent: dendryUI.dendryEngine.state.qualities.left_in_dissent,      color: '#C40000' },
        { name: 'Center',       strength: dendryUI.dendryEngine.state.qualities.center_strength,       dissent: dendryUI.dendryEngine.state.qualities.center_dissent,       color: '#DCCA4A' },
        { name: 'Right Union',  strength: dendryUI.dendryEngine.state.qualities.right_union_strength,  dissent: dendryUI.dendryEngine.state.qualities.right_union_dissent,  color: '#69A2BE' },
        { name: 'Industrial',   strength: dendryUI.dendryEngine.state.qualities.industrial_strength,   dissent: dendryUI.dendryEngine.state.qualities.industrial_dissent,   color: '#D5AC27' },
        { name: 'Right SocDem', strength: dendryUI.dendryEngine.state.qualities.right_socdem_strength, dissent: dendryUI.dendryEngine.state.qualities.right_socdem_dissent, color: '#3F7BC1' },
    ];
    ...
    factions.forEach(function(f, idx) {
        ...
        var xi2 = cx + r * Math.cos(angle + slice);
        var yi2 = cy + r * Math.sin(angle + slice);
        ...
        svg += '<path d="' + path + '" fill="' + f.color + '" stroke="none"'
             ...
             + ' onclick="window.showFactionInfo(' + idx + ')"'
    ...
    var infoBox = '<div id="faction-info" style="text-align:center;font-size:0.85em;min-height:2.5em;padding:0.3em;"></div>';
    container.innerHTML = svg + infoBox;
    window._factionData = factions;
};

window.showFactionInfo = function(idx) {
